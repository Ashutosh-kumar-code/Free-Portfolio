...
import person from "../../assets/svg/person-image.svg";
...
const HeroSection = ({ scrollToSection, refs }) => {
  return (
    <Container>
      <div className="lg:flex lg:flex-row-reverse lg:justify-center lg:items-center pb-10 lg:pb-16 xl:pb-0 xl:justify-between lg:py-0">
        <div className="">
          <img
            src={person}
            alt=""
            className="w-full object-cover lg:ml-10 xl:ml-24"
          />
        </div>
        <div className="">
          <div className=" ">
